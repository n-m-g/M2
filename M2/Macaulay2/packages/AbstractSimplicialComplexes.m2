...
-- A "random seed option" may be added a bit later to allow for
-- reproducibility of random out put if needed.
...
doc ///
     ...
     Description
	  ...
	  Text
	     ...
	     to the signed sum of all lexicographically ordered sets $\{l_0 < ... < l_i\} \backslash \{L_j\}$ as
	     $j$ ranges from $0$ to $i$. 
	  Text  
	     Here, the sign in front of  $\{l_0 < ... < l_i\} \backslash \{l_j\}$ is $(-1)^j$. 
	  Text	  
